...
- Safety Notice: `docs/safety/`
- Local Data & Privacy Choices: `docs/data-choices/`
- Remove-Ads Subscription: `docs/subscription/`

## GitHub Pages

Publish from the `main` branch and `/docs` folder.

Expected project-site base URL once GitHub Pages is enabled:

`https://lrodeveloperr.github.io/kitchen-prep-board-policies-repo/`
